...
handler.on('push', function (event) {
    console.log('Received a push event for %s to %s',
        ...
        event.payload.ref);
    run_cmd('sh', ['/home/ubuntu/deploy/deploy_1605A.sh', event.payload.repository.name], function (text) {
        console.log(text)
...
function sendMials(event){
     ...
     let transporter = nodemailer.createTransport({
        ...
        auth: {
            ...
            pass: 'fopwnytstewvbhbd' // generated ethereal password
        }
    });
